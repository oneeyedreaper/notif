        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8">
              A complete notification management system with email/SMS integration,
              real-time updates, and beautiful UI. Stay connected with your users.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="glass-card">
              <CardHeader>
                ...
                <CardDescription>
                  Respect user&apos;s time with configurable do-not-disturb periods.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
